...
addToDobutton.addEventListener('click', function () {
    ...
    const listIteElementId = generateRandomString(8); //34B69Ym
    ...
    // Append new li element to the todo container
    const existingInnerHtml = toDoContainer.innerHTML;
    toDoContainer.innerHTML = existingInnerHtml + listItemMarkup;
